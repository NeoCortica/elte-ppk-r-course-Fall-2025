...
```{r}
n=100;
#a normál eloszlásból n számú értéket generálunk és kumulatívan építjük őket egymás alá (y mínuszba megy)
x=cumsum(rnorm(n))
...
#sajnos az ágazást nem tudom hozzáadni, de nincs benne loop! megrpóbálom animálni
